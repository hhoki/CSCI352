...
CREATE TABLE `careplan` (
  ...
  KEY `patient_id_idx` (`subject_id`),
  KEY `activity_id_idx` (`activity_id`),
  CONSTRAINT `c_activity_id` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`id`),
  CONSTRAINT `patient_id` FOREIGN KEY (`subject_id`) REFERENCES `patient` (`id`)
